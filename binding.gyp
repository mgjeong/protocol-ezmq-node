  ...
  "targets": [
    {
      ...
      'conditions': [
          ...
          ['config=="armhf_release"',
            {          
              "ldflags": [
              "-L<(module_root_dir)/dependencies/protocol-ezmq-cpp/out/linux/armhf/release/",
              "-Wl,-rpath,<(module_root_dir)/dependencies/protocol-ezmq-cpp/out/linux/armhf/release/",
              ]
            }
          ],
          ['config=="armhf_debug"',
              {
                "ldflags": [
                "-L<(module_root_dir)/dependencies/protocol-ezmq-cpp/out/linux/armhf/debug/",
                "-Wl,-rpath,<(module_root_dir)/dependencies/protocol-ezmq-cpp/out/linux/armhf/debug/",
                ]
              }
          ],
       ], 
